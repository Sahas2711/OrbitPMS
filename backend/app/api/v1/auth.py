...
@router.post(
    ...
    description="Creates a new user account with email uniqueness and password strength validation.",
    responses={
...
async def register(
    ...
    logger.info("User registered: email=%s role=%s", response.email, response.role)
    return response
